package com.vlat.MessageCollectorServer.utility;
...
@Component
public class SMSCAPIHelper {

    @Value("${config.smsc.login}")
    String SMSC_LOGIN ;     // логин клиента
    @Value("${config.smsc.password}")
     ...
     * constructors
     */
    public SMSCAPIHelper() {
    }

    public SMSCAPIHelper(String login, String password) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
    }

    public SMSCAPIHelper(String login, String password, String charset) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
    }

    public SMSCAPIHelper(String login, String password, String charset, boolean debug) {
        SMSC_LOGIN    = login;
        SMSC_PASSWORD = password;
        SMSC_CHARSET  = charset;
        SMSC_DEBUG    = debug;
